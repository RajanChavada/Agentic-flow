---
name: backend
description: Backend implementation with FastAPI/Pydantic patterns. Enforces Neurovn's registry conventions, model separation, and verification steps.
allowed-tools:
  - Read
  - Write
  - Edit
...
- Run `cd backend && python -c "from main import app"` -- clean import required

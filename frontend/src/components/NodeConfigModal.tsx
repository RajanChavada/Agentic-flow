    ...
    <div className="fixed inset-0 z-50 pointer-events-none">
      ...
      >
        ...
        <div
          ...
          className={`shrink-0 flex items-center justify-between px-5 py-3 rounded-t-lg cursor-grab active:cursor-grabbing select-none border-b ${isDark
        ...
        >
          ...
          <button
            ...
            className={`rounded-md min-h-11 min-w-11 flex items-center justify-center transition-colors ${isDark ? "hover:bg-slate-700 text-slate-400" : "hover:bg-gray-200 text-gray-400"
              }`}
          >
          ...
          {isConditionNode ? (
            ...
            <>
              ...
              <textarea
                ...
                rows={4}
                className={`w-full rounded border px-3 py-2 text-sm mb-4 resize-none ${isDark
                  ? "bg-slate-700 border-slate-500 text-slate-100 placeholder-slate-500"
                  : "bg-white border-gray-300 text-gray-800"
                  }`}
